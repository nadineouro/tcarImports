class Header extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <nav>
        <ul>
          <li><a class="carLink" id="porsche" href="porsche.html">Porsche</a></li>
          <li><a class="carLink" id="bmw" href="bmw.html">BMW</a></li>
          <li><a class="carLink" id="ferrari" href="ferrari.html">Ferrari</a></li>
          <li><a class="carLink" id="audi" href="audi.html">Audi</a></li>
        </ul>
      </nav>
      <a id="aboutUs" href="about-us.html">Sobre nós</a>
    </header>
    `;
  }
}
